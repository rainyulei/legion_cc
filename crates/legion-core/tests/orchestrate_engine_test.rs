...
async fn test_submit_ticket() {
    ...
    let id = engine.submit_ticket("Fix bug #42".into(), "Fix bug #42".into(), None, None, TeamMode::TechLeadTeam, 5, Vec::new(), None, false).await.unwrap();
    assert_eq!(id, 1);
...
async fn test_take_next() {
    let engine = OrchestrateEngine::new(2);
    engine.submit_ticket("Task A".into(), "Task A".into(), None, None, TeamMode::Solo, 3, Vec::new(), None, false).await.unwrap();
...
async fn test_report_iteration_success() {
    let engine = OrchestrateEngine::new(2);
    engine.submit_ticket("Task B".into(), "Task B".into(), None, None, TeamMode::TechLeadTeam, 5, Vec::new(), None, false).await.unwrap();
...
async fn test_report_iteration_retry() {
    let engine = OrchestrateEngine::new(2);
    engine.submit_ticket("Task C".into(), "Task C".into(), None, None, TeamMode::TechLeadTeam, 3, Vec::new(), None, false).await.unwrap();
    engine.take_next(1).await;
...
async fn test_report_iteration_max_exceeded() {
    let engine = OrchestrateEngine::new(2);
    engine.submit_ticket("Task D".into(), "Task D".into(), None, None, TeamMode::Solo, 2, Vec::new(), None, false).await.unwrap();
    engine.take_next(1).await;
...
async fn test_stop_all() {
    let engine = OrchestrateEngine::new(3);
    engine.submit_ticket("T1".into(), "T1".into(), None, None, TeamMode::default(), 5, Vec::new(), None, false).await.unwrap();
    engine.submit_ticket("T2".into(), "T2".into(), None, None, TeamMode::default(), 5, Vec::new(), None, false).await.unwrap();
    engine.take_next(1).await;
...
async fn test_queue_stats() {
    ...
    engine.submit_ticket("T1".into(), "T1".into(), None, None, TeamMode::default(), 5, Vec::new(), None, false).await.unwrap();
    engine.submit_ticket("T2".into(), "T2".into(), None, None, TeamMode::default(), 5, Vec::new(), None, false).await.unwrap();
    engine.submit_ticket("T3".into(), "T3".into(), None, None, TeamMode::default(), 5, Vec::new(), None, false).await.unwrap();
...
async fn test_worker_idle() {
    ...
    engine.submit_ticket("Task".into(), "Task".into(), None, None, TeamMode::default(), 5, Vec::new(), None, false).await.unwrap();
    engine.take_next(1).await;
    assert!(!engine.is_worker_idle(1).await);
